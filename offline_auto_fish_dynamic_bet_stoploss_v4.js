(function () {
  ...
  function createState() {
    ...
    return {
      ...
      config: {
        ...
        missStreakLeaveThreshold: 2,
        precisionBlockedLeaveThreshold: 3,
        blockedDeadRoomLeaveThreshold: 5,
        blockedDeadRoomMinStayMs: 8000,
        blockedNoBulletLeaveThreshold: 2,
        blockedNoBulletMinStayMs: 2500,
        ...
        blockedRoomLeaveSeconds: 26,
        blockedRoomLeaveMinRoomStaySeconds: 16,
        blockedRoomLeaveWarmingMinScore: 42,
        blockedRoomLeaveWarmingExtraSeconds: 22,
        ...
        postLeaveRejoinMinDelayMs: 2500,
        postLeaveRejoinMaxDelayMs: 4500,
        fastLeaveRejoinMinDelayMs: 1500,
        fastLeaveRejoinMaxDelayMs: 3200,
        lossRoomRejoinMinDelayMs: 5000,
        lossRoomRejoinMaxDelayMs: 9000,
        badRoomPauseThreshold: 5,
        badRoomPauseMs: 12000,
  ...
  function shouldLeaveBlockedDeadRoom(runtimeState, config, roomStatus, analysis) {
    ...
    if (
      ...
      Math.max(
        noBulletDeadRoom
          ? Math.min(toInt(config.blockedNoBulletMinStayMs, 2500), 1500)
  ...
  function buildPanelOverviewHtml(status) {
    ...
    return (
      ...
      buildPanelMetricHtml("开火资格", guardLabel, guardTone) +
